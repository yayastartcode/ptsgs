      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <div>
                  <div className="font-semibold text-primary-light mb-1">Alamat:</div>
                  <span className="text-sm">Telaga murni BLOK C10A
                    CIKARANG BARAT. KAB BEKASI</span>
                </div>
              </li>
          ...
          <div>
            ...
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d328.2106932471461!2d107.11638202869706!3d-6.260311990638627!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69856e4c6a63ff%3A0x560ec1a6ac90820e!2sJl.%20Telaga%20Murni%20Raya%20Blok%20C10A%20No.12%2C%20Telagamurni%2C%20Kec.%20Cikarang%20Bar.%2C%20Kabupaten%20Bekasi%2C%20Jawa%20Barat%2017530!5e0!3m2!1sid!2sid!4v1773198169058!5m2!1sid!2sid"
              width="100%"
              height="200"
              style={{ border: 0 }}
              allowFullScreen=""
